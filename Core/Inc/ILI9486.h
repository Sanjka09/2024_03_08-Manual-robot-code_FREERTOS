...
#define LCD_CS_0        HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4, 0);
#define LCD_CS_1        HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4, 1);
#define PWM_SetValue
#define LCD_RST_0       HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, 0);
#define LCD_RST_1       HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, 1);

#define LCD_DC_0        HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, 0);
#define LCD_DC_1        HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, 1);
