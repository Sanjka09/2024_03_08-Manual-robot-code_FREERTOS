...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM1_CH1_ENCODER1_A_Pin|TIM1_CH2_ENCODER1_B_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM2_CH1_ENCODER2_A_Pin|TIM2_CH2_ENCODER2_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, TIM4_CH1_ENCODER4_A_Pin|TIM4_CH2_ENCODER4_B_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, TIM8_CH1__ENCODER3_A_Pin|TIM8_CH2__ENCODER3_B_Pin);
