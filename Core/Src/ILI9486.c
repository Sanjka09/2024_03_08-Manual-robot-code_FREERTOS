...
LCD_DIS sLCD_DIS;
extern uint16_t x_g[9];
extern uint16_t y_g[9];
extern int space;
extern int space_1;
/*******************************************************************************
function:
...
/******************************************************************************
  ...
  Show Pic
******************************************************************************/
//void GUI_switch_idevhjeegui(void)
//{
////SWITCH
...
//
//  }
//void GUI_switch_idevhjsen(void)
//{
////SWITCH
//	GUI_DrawRectangle(x_g[0]+space_1, y_g[1]+space_1, x_g[1]-space_1, y_g[2]-space_1, GREEN, DRAW_EMPTY, DOT_PIXEL_DFT);
//	GUI_DrawRectangle(x_g[0]+space_1, y_g[2]+space_1, x_g[1]-space_1, y_g[3]-space_1, GREEN, DRAW_EMPTY, DOT_PIXEL_DFT);
//	GUI_DrawRectangle(x_g[3]+space_1, y_g[2]+space_1, x_g[4]-space_1, y_g[3]-space_1, GREEN, DRAW_EMPTY, DOT_PIXEL_DFT);
//	GUI_DrawRectangle(x_g[3]+space_1, y_g[1]+space_1, x_g[4]-space_1, y_g[2]-space_1, GREEN, DRAW_EMPTY, DOT_PIXEL_DFT);
//	GUI_DrawCircle((x_g[3]+x_g[2])/2, ((y_g[3])+(y_g[1]))/2, 20, RED, DRAW_EMPTY, DOT_PIXEL_DFT);
//	GUI_DrawCircle((x_g[2]+x_g[1])/2, ((y_g[3])+(y_g[1]))/2, 20, RED, DRAW_EMPTY, DOT_PIXEL_DFT);
//
//  }
//void GUI_relay(void)
//{
...
//}
//void GUI_encoder_velocity(void)
//{
...
//	GUI_DisString_EN(x_g[0]+space, y_g[4], "Hurd=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[0]+space, y_g[4]+4*space, "Encoder=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[0]+space, y_g[4]+8*space, "PWM=", &Font12, LCD_BACKGROUND, WHITE);
//
//	GUI_DisString_EN(x_g[6]+space, y_g[4], "Hurd=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[6]+space, y_g[4]+4*space, "Encoder=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[6]+space, y_g[4]+8*space, "PWM=", &Font12, LCD_BACKGROUND, WHITE);
//
//	GUI_DisString_EN(x_g[0]+space, y_g[6]+2*space, "Hurd=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[0]+space, y_g[6]+6*space, "Encoder=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[0]+space, y_g[6]+10*space, "PWM=", &Font12, LCD_BACKGROUND, WHITE);
//
//	GUI_DisString_EN(x_g[6]+space, y_g[6]+2*space, "Hurd=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[6]+space, y_g[6]+6*space, "Encoder=", &Font12, LCD_BACKGROUND, WHITE);
//	GUI_DisString_EN(x_g[6]+space, y_g[6]+10*space, "PWM=", &Font12, LCD_BACKGROUND, WHITE);
//}
